<?php
$conn = mysqli_connect("localhost", "id21580214_vollerei", "Lamongan_02", "id21580214_mydb");
...
function kirimBukti($data, $idPembeli)
{
    ...
    mysqli_query($conn, "INSERT INTO `pembayaran` (`id_pembelian`, `Nama`, `Bank`, `tanggal`, `Bukti`, `Jumlah`)
