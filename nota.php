...
<head>
    ...
    <title>Toko berkah - Detail Pembelian</title>
...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: #979890;">
            <div class="container"><img src="assets/img/toko1.png" style="width: 100px;"><a class="navbar-brand" href="#" style="font-size: 23px;">Toko sembako berkah</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="odd">
                                                    ...
                                                    <td><?= $barang["nama"]; ?></td>
                                                    <td><?= substr($barang['deskripsi'], 0, 1000), ""; ?></td>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group alert alert-info w-auto">
                                        <p class="w-100" style="font-size: medium;">
                                            ...
                                            <!-- <br> -->
                                            <strong>BANK BRI 1234-0101-0891-531 AN. toko berkah</strong>
                                        </p>
                                    </div>
                                </div>
                                <?php
                                
                                    $ambil = mysqli_query($conn, "SELECT * FROM pembelian_barang INNER JOIN pelanggan ON pembelian_barang.id_pelanggan = pelanggan.id_pelanggan WHERE id_pembelian='$_GET[id]'");
                                    $data = mysqli_fetch_assoc($ambil);

                                    if ($data['status_pembelian'] == 'Lunas') {
                                        // Jika status pembayaran sudah lunas, tampilkan teks "Transaksi Lunas"
                                        ?>
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group text-center">
                                                <p><strong>Transaksi Lunas</strong></p>
                                            </div>
                                        </div>
                                        <?php
                                    } else {
                                        // Jika status pembayaran belum lunas, tampilkan tombol "Konfirmasi Pembayaran"
                                        ?>
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group text-center">
